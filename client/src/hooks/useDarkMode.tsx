...
export const DarkModeContextProvider: FC = (props) => {
    ...
    return (
        <DarkModeContext.Provider value={{ isAdminOrPrylis, isDarkModeEnabled, refetch: doFetch }}>
            {props.children}
...
export const useDarkMode = () => {
    ...
    if (!context) throw new Error("useDarkMode must be used inside DarkModeContextProvider")
